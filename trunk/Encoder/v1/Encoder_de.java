    // File:         Encoder.java
    // Created:      8/10/2011
    // Template:     Jason Appelbaum Jason@Hak5.org
    // Mod:          Snake 12/02/2012 (DE)
    // Thanks:       PCFreak - Testing     
    ...
    public class Encoder_de {
                    ...
                    for (int i = 0; i < instructions.length; i++) {
                            try {
                                    ...
                                    if (instruction[0].equals("DEFAULT_DELAY")
                                            ...
                                            file.add((byte) 0xE2);
                                    } else if (instruction[0].equals("ALT+GR")) {
                                            file.add((byte) 0x40);
                                            file.add((byte) 0x00);
            ...
            private static byte charToByte(char c) {
                    ...
                    if ((int) c >= 97 && (int) c <= 120)
                            // lower case letters
                            return (byte) (c - 0x5D);
                    else if ((int) c >= 65 && (int) c <= 88)
                            // upper case letters
                            return (byte) (c - 0x3D);
